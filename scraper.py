...
def run_scraper():
    ...
    # 定義目標行政區與診所科別類別
    districts = ['台中市北區', '台中市西區', '台中市東區', '台中市中區', '台中市烏日區', '台中市霧峰區', '台中市清水區', '台中市大甲區', '台中市神岡區', '台中市后里區', '台中市石岡區', '台中市外埔區', '台中市東勢區', '台中市新社區', '台中市北屯區', '台中市大肚區','彰化縣鹿港鎮', '彰化縣和美鎮', '彰化縣溪湖鎮', '彰化縣二林鎮', 
        '彰化縣田中鎮', '彰化縣北斗鎮', '彰化縣花壇鄉', '彰化縣秀水鄉',
        '彰化縣伸港鄉', '彰化縣大村鄉', '彰化縣永靖鄉', '彰化縣埔鹽鄉']
